...
const Fail = () => {
    ...
    <Row>
        ...
        <Col style={{ border: "2px solid #ff0000", marginTop: "20px", background: "#25252f",padding: "20px", borderRadius: "20px", display: "flex", flexDirection: "column", alignItems: "center" }} md={6} xs={10} sm={6}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }} className='flex flex-col items-center p-[30px] bg-[#25252f] b-rad rounded-[20px] my-5 w-[400px] border-solid border-[2px]'>
            ...
            <img className='h-28' style={{ height: "112px" }} src='/fail.png' />
        </div>
        </Col>
    </Row>
    </Container>
